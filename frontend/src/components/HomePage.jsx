  ...
  return (
    <main className="flex flex-col flex-1 gap-3 justify-center p-4 pb-40 text-center sm:gap-4 md:gap-5">
      <h1 className="text-4xl font-black text-primary sm:text-5xl md:text-6xl">
        QA{" "}
        <span className="text-2xl text-neutral-content sm:text-3xl md:text-4xl">
          Annotator
        </span>
      </h1>
      <h3 className="font-semibold md:text-xs text-slate-500">
        Context <span className="text-accent">&#43;</span> Question{" "}
        <span className="text-accent">&#43;</span> Answer{" "}
        <span className="text-accent">&#61;</span> Dataset
      </h3>
      <button
      ...
      >
        <p>
          Upload Context{" "}
          <span className="text-xs text-neutral-content">.csv file format</span>
        </p>
      ...
      <div className="gap-4 justify-between mx-auto my-4 w-72 max-w-full text-xs text-neutral-content">
        <i className="fa-solid fa-circle-info"></i>
        <p className="py-2 text-justify text-neutral-content">
